...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.d680ecc8.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.6630269d.mjs'));
...
//# sourceMappingURL=error-component.59760fb6.mjs.map
